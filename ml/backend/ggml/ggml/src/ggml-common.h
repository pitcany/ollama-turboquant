...
// Storage block size = 128 (matches rotation group)
// Transform group size = 128 (head_dim, for rotation Gaussianization)
// Per block: norm(fp16) + 2-bit indices (8 bytes) + 1-bit extra (4 bytes) = 14 bytes per 128 values
// = 0.875 bits/value -> 18.3x compression vs fp16
