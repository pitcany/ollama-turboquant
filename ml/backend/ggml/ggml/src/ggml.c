...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO4_0_64] = {
        .type_name                = "turbo4_64",
        .blck_size                = QK_TURBO_64,
        .type_size                = sizeof(block_turbo4_0_64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo4_0_64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo4_0_64_ref,
    },
    [GGML_TYPE_TURBO2_0_64] = {
        .type_name                = "turbo2_64",
        .blck_size                = QK_TURBO_64,
        .type_size                = sizeof(block_turbo2_0_64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo2_0_64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo2_0_64_ref,
    },
    [GGML_TYPE_TURBO3_0_64] = {
        .type_name                = "turbo3_64",
        .blck_size                = QK_TURBO_64,
        .type_size                = sizeof(block_turbo3_0_64),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo3_0_64,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo3_0_64_ref,
    },
    [GGML_TYPE_Q2_K] = {
        .type_name                = "q2_K",
        .blck_size                = QK_K,
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_TURBO4_0_64: result = quantize_turbo4_0_64(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_TURBO2_0_64: result = quantize_turbo2_0_64(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        case GGML_TYPE_TURBO3_0_64: result = quantize_turbo3_0_64(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
